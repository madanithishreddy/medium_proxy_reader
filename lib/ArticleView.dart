...
(function () {
  ...
  const floatingCandidates = document.querySelectorAll(
    '[class*="freedium"][class*="menu"], [id*="freedium"][id*="menu"], [class*="floating"][class*="menu"], [class*="floating"][class*="share"], [aria-label*="share" i], [aria-label*="menu" i]'
  );
  ...
  return originalLink ? originalLink.href : '';
})();
''');
